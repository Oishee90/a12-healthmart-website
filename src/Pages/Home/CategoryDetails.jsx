...
const CategoryDetails = () => {
    const { categoryName } = useParams(); // Get the categoryName parameter from URL
    ...
    <img src={item.image} />
                  ...
                  <td className="border font-raleway font-bold hover:bg-blue-50 border-blue-500 px-4 py-2">
                    ...
                    <Link to={`/update/${item._id}`}>
                      <button className=" flex flex-col md:flex-row gap-2 items-center transition duration-1000 ease-in cursor-pointer bg-blue-300  hover:bg-blue-500 font-ubuntu hover:text-white text-black font-bold py-2 px-4 rounded"> <MdFileDownloadDone /> Add To Cart</button>
                    </Link>
                    </td>
                    <td className="border font-raleway font-bold hover:bg-blue-50 border-blue-500 px-4 py-2">
                  <button
